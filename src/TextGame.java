...
//        GameController xboxAdapter = new XboxControllerAdapter(xboxController);
//        console.connectController(xboxAdapter);

//uncomment for playStation
//        PlayStationController playStationController = new PlayStationController();
//        GameController playStationAdapter = new PlayStationControllerAdapter(playStationController);
//        console.connectController(playStationAdapter);


        if(console.isButtonPressed(e.getKeyChar())== null)
            return;
        char key = console.isButtonPressed(e.getKeyChar());;
